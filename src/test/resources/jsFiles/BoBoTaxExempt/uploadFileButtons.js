...
let rootNode = xpathSingleEval("//div[contains(@class, 'modal-footer slds-modal__footer')]", document);
let listItem = document.evaluate(".//button", rootNode, null, XPathResult.ORDERED_NODE_ITERATOR_TYPE, null);
